...
<div class="container-fluid  overflow-hidden p-0 register_job_offer">
    ...
    <div class="row">
        ...
        @endslot
                    ...
                    <form method="POST" action="{{route('update/job',['id'=>$employer->id,'offer_id'=>$job_offer->id])}}" enctype="multipart/form-data"
                        ...
                        <div class="job_offer_header">
                            ...
                            value="{{$related_job_offer->offer_title}}" />
                            @error('offer_title')
                            ...
                            <div class="job_offer_type col-lg-6">
                                ...
                                <select name="type_emploi" class="custom-select mr-sm-2 @error('type_emploi') is-invalid @enderror" id="inlineFormCustomSelect">
                                    <option value="0" disabled selected>type d'emploi</option>
                        ...
                        <label class=" p-3">categorie</label>
                        ...
                        <div class=" job_ofer_img col-12 col-sm-6 col-md-6 col-lg-6 ">
                            <label for="" class="mb-3">télécharger image</label>
                            <div class="input-group mb-3 btn-light @error('offer_image') is-invalid @enderror">

                                <div class="custom-file">

                                    <input name="offer_image" type="file" class="custom-file-input"
                        ...
                        <div class="job_offer_salary col-lg-12">
                            <select name="salary" class="custom-select mb-2 mr-sm-2 @error('salary') is-invalid @enderror" id="inlineFormCustomSelect">
                                <option value="0" disabled selected> salaire</option>
                        ...
                        <div class="job_offer_experience mb-3 col-lg-12">
                            <select name="experience" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                <option value="0" disabled selected>experience</option>
                                <option value="0-6">0 - 6mois</option>
                                <option value="6-1">6mois - 1ans</option>
                                <option value="1-2">1ans - 2ans</option>
                                <option value="2-4">2ans - 4ans</option>
                        ...
                        <label for="" class="ml-3">tags</label>
                        <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                    <input type="submit" value="update job offer" class="login-input mt-4 ">
                    </div>
