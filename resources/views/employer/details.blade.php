...
<div class="container dashboard-header mt-5">
 <div class="top-resume d-flex justify-content-between align-items-center">
   ...
   <div class="p-2 pic-resume"> <img  style="width:90px;height:90px" src="{{asset('img/'.$employer->profile_picture)}}" alt=""></div>
     <div class="p-2">
     <div class=" "><h3 class="font-weight-bold">{{$employer->username}}</h3></div>
        ...
        <div>
            ...
            <button type="button" class="btn btn-success download-fiche"><a  method="get" href="{{route('download/fiche',['id'=>$employer->id,'username'=>$employer->username])}}"  class="active">download fiche</a></button>
       ...
       <div class="col-xl-4 resume-side-bar">
            <div class="sidebar-content">
                ...
                <ul class="list-resume-info">
                    <li> <span> entreprise name:</span> <span class="resume-info-title">{{$employer->entreprise_name}} </span></li>
                    ...
                    <li> <span> team-members:</span> <span class="resume-info-title"> </span></li>
                    <li> <span> gender:</span> <span class="resume-info-title"> {{$employer->gender}} </span></li>
                    <li> <span> phone:</span> <span class="resume-info-title"></span></li>
                    <li> <span> age:</span> <span class="resume-info-title">  {{$employer->age}}</span></li>
